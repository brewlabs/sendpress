...
class SendPress_View_Settings_Systememailedit extends SendPress_View_Settings {
	...
	function html($sp) {
		...
		*/
        ...
        $options = SendPress_Option::email_get( 'systememail_' . $post_ID  );
     ...
     <form method="post" id="post" role="form">
       ...
       <div style="float:right;" class="btn-toolbar">
            <div id="sp-cancel-btn" class="btn-group">
               <?php if($post->post_status != 'sp-systememail'  ) { ?>
