		...
		switch($column_name){
		   ...
		   */
			...
			case 'actions':
				...
				*/
				$a .= '<a class="btn btn-primary" href="?page='.SPNL()->validate->page($_REQUEST['page']).'&view=tempedit&templateID='. $item->ID .'"><span class="glyphicon glyphicon-edit"></span> ' . __('Edit','sendpress') . '</a> ';
				/*
